...
# PSGD  
step_size = 0.05
grad_norm_clip_thr = 1e10 # may be necessary for RNN training; otherwise, set it to an arbitrarily large value or inf  
...
import scipy.io
scipy.io.savemat('scan_precond.mat', {'TrainLoss': TrainLoss, 'TestLoss': TestLoss})